...
class ItemController extends Controller
{
	...
	public function actionNovo()
	{
		...
		if(isset($_POST['Item']))
		{
			...
			if($model->save())
			{
				$codigoTema = $model->idTema0->codigo;	
				Yii::app()->user->setFlash('success', 'Dados Salvos.');
				$model=new Item;
				$model->codigoTema = $codigoTema;
				$model->idTema = $_POST['Item']['idTema'];
				$model->codigo = $_POST['Item']['codigo']+1;
			}
		}
	...
	{
		$model=(is_null($this->_model)) ? new Item : $this->_model;			
		$dataProvider=new CActiveDataProvider('Item', array('pagination'=>false));
